...
export default function Home() {
  return (
    <div className="min-h-screen bg-background selection:bg-primary/30 overflow-hidden">
      ...
      <header className="container mx-auto px-4 py-6 flex items-center justify-between relative z-10 animate-in fade-in duration-500">
      ...
      <main className="container mx-auto px-4 pt-20 pb-32 sm:pt-32 sm:pb-40 lg:pb-48 relative">
          ...
          <div className="rounded-2xl border border-border/50 bg-card/40 backdrop-blur-2xl shadow-2xl overflow-hidden ring-1 ring-white/10">
            ...
            <div className="p-6 md:p-8 grid gap-5 grid-cols-1 md:grid-cols-3 bg-gradient-to-b from-transparent to-muted/5 relative">
              ...
              <div className="rounded-xl border border-border/60 bg-card/80 p-6 shadow-lg space-y-4 hover:border-primary/50 transition-all hover:-translate-y-1 relative group">
                ...
                <div className="flex items-center gap-2 text-xs font-medium border-t border-border/50 pt-4 mt-4">
                  <span className="px-2.5 py-1 rounded-md bg-secondary/80 text-secondary-foreground">Hosting</span>
                  <span className="flex items-center gap-1 text-muted-foreground ml-auto"><Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500 drop-shadow-sm" /> Watchlisted</span>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-border/60 bg-card/80 p-6 shadow-lg space-y-4 hover:border-blue-500/50 transition-all hover:-translate-y-1 relative group md:-translate-y-4">
                ...
                <div className="flex items-center gap-2 text-xs font-medium border-t border-border/50 pt-4 mt-4">
                  <span className="px-2.5 py-1 rounded-md bg-secondary/80 text-secondary-foreground">Repository</span>
                  <span className="flex items-center gap-1 text-muted-foreground ml-auto"><Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500 drop-shadow-sm" /> Watchlisted</span>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-border/60 bg-card/80 p-6 shadow-lg space-y-4 hover:border-emerald-500/50 transition-all hover:-translate-y-1 relative group md:translate-y-2 hidden md:block">
                ...
                <div className="flex items-center gap-2 text-xs font-medium border-t border-border/50 pt-4 mt-4">
                  <span className="px-2.5 py-1 rounded-md bg-secondary/80 text-secondary-foreground">Database</span>
                  <span className="flex items-center gap-1 text-muted-foreground ml-auto hover:text-emerald-500 cursor-pointer transition-colors"><Star className="w-3.5 h-3.5" /> Track Resource</span>
                </div>
              </div>
            </div>
          </div>
